#!/usr/bin/env node
// Renders docs/roadmap/cloud-platform-roadmap.html to docs/GardenWise-Cloud-Platform-Roadmap.pdf
// using a locally installed Chrome or Edge in headless mode.
//
//   node scripts/build-roadmap-pdf.mjs
...
const source = resolve(repoRoot, "docs/roadmap/cloud-platform-roadmap.html");
const output = resolve(repoRoot, "docs/GardenWise-Cloud-Platform-Roadmap.pdf");
